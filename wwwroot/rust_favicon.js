...
*/
export function favicon_generate(input_color, image_data) {
    const ptr0 = passStringToWasm0(input_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(image_data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.favicon_generate(ptr0, len0, ptr1, len1);
}
...
* @returns {string}
*/
export function favicon_check(image_data) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.favicon_check(retptr, ptr0, len0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_favicon_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
